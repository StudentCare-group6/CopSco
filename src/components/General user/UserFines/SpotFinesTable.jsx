...
export default function SpotFinesTable() {
    ...
    if (spotFines.length === 0 || spotFines === undefined) {
        ...
        const columns = [
            ...
            { field: "amount", headerName: "Total Payable", width: 150, headerAlign: "center" },
            { field: "dueDate", headerName: "Due Date", width: 150, headerAlign: "center" },
            { field: "demerits", headerName: "Demerit Points", width: 150, headerAlign: "center" },
