...
export default function Sidebar() {
  ...
  const routes = [
    "/police-division/",
    "/police-division/adding-officers",
    "/police-division/viewDocuments",
    "/police-division/addAppeals",
    "/police-division/information",
    "/logout",
  ];
            ...
            if (index === 5) {
              return (
                <ListItem
                  ...
                  className={
                    isActive
                      ? "text-slate-950 bg-slate-400 rounded-lg"
                      : " text-slate-400 hover:bg-slate-600 rounded-lg"
                  }
                >
                  <ListItemButton
                    sx={{
