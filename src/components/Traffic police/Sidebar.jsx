...
export default function Sidebar() {
    ...
    const routes = ['/traffic-police/', '/traffic-police/profile', '/traffic-police/notifications', '/traffic-police/statistics', '/traffic-police/information', '/traffic-police/logout'];
