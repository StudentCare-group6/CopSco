...
import MultipleSelectChip from './ChippedInput';
...
const LicenseData = ['01/01/2021', '12:00 PM',<DropDown valuesArr={policeDivisions}/>,<DropDown valuesArr={policeStations}/>, <MultipleSelectChip/>, 'Rs. 5000', '8'];
